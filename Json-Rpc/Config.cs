...
{
    /// <summary>
    ///     The PreProcessHandler is called after the request has been parsed and prior to calling the associated method on the
    ///     JsonRpcService.
    ///     If any non-null result is returned from the PreProcessHandler, the operation is aborted and the error is returned
    ///     to the caller.
    /// </summary>
    ...
    ///     If any non-null result is returned from the PostProcessHandler, the current return value is discared and the new
    ///     return value used
    ///     in preference.
    /// </summary>
    ...
    public static class Config
    {
        ...
        /// <param name="sessionId"></param>
        /// <param name="handler"></param>
        public static void SetErrorHandler(string sessionId,
            Func<JsonRequest, JsonRpcException, JsonRpcException> handler)
        {
        ...
        /// <param name="sessionId"></param>
        /// <param name="handler"></param>
        public static void SetParseErrorHandler(string sessionId,
            Func<string, JsonRpcException, JsonRpcException> handler)
        {
